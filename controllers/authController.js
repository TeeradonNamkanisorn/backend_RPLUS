...
exports.registerTeacher = async (req, res, next) => {
    try {
        ...
        const {username, email, password, firstName, lastName, creditCardNumber, creditCardName, bankCode} = req.body;
        ...
        const newTeacher = await Teacher.create({id: newId, username, email, password: hashedPassword, firstName, lastName, creditCardNumber, creditCardName, bankCode});
